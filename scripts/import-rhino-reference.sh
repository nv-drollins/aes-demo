...
MANIFEST="${AEC_RHINO_REFERENCE_JSON:-/tmp/aec-demo-rhino-reference.json}"
...
AEC_RHINO_REFERENCE_JSON="$MANIFEST" ROOT="$ROOT" python3 - <<'PY'
import os
from pathlib import Path
import xmlrpc.client

root = Path(os.environ["ROOT"])
manifest = os.environ["AEC_RHINO_REFERENCE_JSON"]
...
code = (
    "import os\n"
    f"os.environ['AEC_RHINO_REFERENCE_JSON'] = {manifest!r}\n"
